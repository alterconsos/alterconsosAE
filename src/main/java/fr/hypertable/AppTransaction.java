...
public class AppTransaction {
	...
	private final Hashtable<String, Cell> transactionCache = new Hashtable<String, Cell>();
	...
	private final Resultat resultat = new Resultat();
	...
	private static final Hashtable<String, Cell> localeCache = new Hashtable<String, Cell>();
	private static final Hashtable<String, Long> localeCacheStamps = new Hashtable<String, Long>();
	...
	private final LinkedList<Cell> bkTrCache = new LinkedList<Cell>();
