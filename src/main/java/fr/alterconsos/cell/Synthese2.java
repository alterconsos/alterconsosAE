...
public class Synthese2 {
	...
	private final int dateDuJourI;
	private final int lundiSP; // semaine précédente
	...
	private static final String[] libs = {"", "Groupement ", "Groupe ", ""};
	...
	private String editGrp(Calendrier.Livr l, String c4, boolean sp) {
		...
		Entry en = Directory.entryG(authType == 1 ? 2 : 1, authType == 1 ? l.gap() : l.gac());
